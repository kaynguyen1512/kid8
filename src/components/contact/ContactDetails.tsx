      ...
      <div className="container-page relative">
        ...
        <div className="mt-14 grid gap-8 lg:grid-cols-12 lg:items-stretch">
          ...
          <div className="lg:col-span-5">
            <div
              className="relative flex h-full w-full min-w-0 max-w-[520px] flex-col overflow-hidden bg-cream-50 p-10 shadow-card ring-1 ring-ink-300/20 md:p-12 lg:min-w-[360px] lg:min-h-[520px] lg:p-14"
              style={cardShape}
            >
          ...
          <div className="lg:col-span-7">
            <div
              className="h-[400px] overflow-hidden bg-cream-50 p-3 shadow-card ring-1 ring-ink-300/20 lg:h-full lg:min-h-[520px]"
              style={mapShape}
            >
              <iframe
